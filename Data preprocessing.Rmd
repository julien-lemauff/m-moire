...
```{r cache=TRUE,include=T,message=FALSE, warning=FALSE, eval=TRUE}
...
# # Since only a handfull of 699 observations (1,5%) out of more than 50000 housing
...
```{r cache=TRUE,include=T,message=FALSE, warning=FALSE, eval=FALSE}
